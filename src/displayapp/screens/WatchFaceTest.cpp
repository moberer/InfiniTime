#include "displayapp/screens/WatchFaceTest.h"
...
WatchFaceTest::WatchFaceTest(Controllers::DateTime& dateTimeController,
...
WatchFaceTest::~WatchFaceTest() {
  lv_task_del(taskRefresh);
  lv_obj_clean(lv_scr_act());
}

void WatchFaceTest::Refresh() {
  statusIcons.Update();
